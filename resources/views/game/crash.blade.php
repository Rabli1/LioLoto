      ...
      <div class="row g-4 align-items-start">
          ...
          <section id="betContainer" class="p-3 rounded bg-dark text-start">
            ...
            <form class="w-100">
              <div class="mb-4">
                ...
                <input type="number" class="form-control" min="1" max="{{ $playerBalance }}" name="bet" id="bet">
              </div>
              ...
              <div class="d-flex flex-wrap gap-2 mt-4">
                <button id="clearBet" class="btn btn-light flex-fill" type="button">Effacer la mise</button>
                <button id="placeBet" class="btn btn-danger flex-fill" type="button" 
        ...
        <div class="col-12 col-lg-8">
          <section id="gameMat" class="p-3 rounded bg-dark text-center">
            <span id="crash-multiplier" class="fs-4 text-light d-block mb-2">1.00x</span>
