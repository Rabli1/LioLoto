    ...
    <div class="container">
        <section class="game-outline text-center">
            <header class="mb-4">
                ...
                <span class="balance">Solde : $<span id="coinflip-balance" data-balance>{{ number_format($playerBalance, 0, '', ' ') }}</span></span>
            </header>
            ...
            <section id="betContainer" class="mb-4">
                ...
                <div class="d-flex flex-row justify-content-center">
                    ...
                    <button id="startRound" class="btn btn-danger mt-2" type="button" @if(!session()->has('user')) disabled @endif>Lancer</button>
                </div>
            </section>
            ...
            <section id="gameControls" class="mb-4">
                <div class="d-flex flex-wrap justify-content-center gap-3 align-items-center">
                    ...
                    <input id="targetInput" type="number" class="form-control form-control-sm" value="50" min="1" max="99" style="width: 90px;">
                    <input id="targetSlider" type="range" class="form-range" value="50" min="1" max="99" style="max-width: 240px;">
                </div>
                <div class="d-flex justify-content-center gap-3 mt-3">
                    <button id="chooseUnder" class="btn btn-outline-light active" type="button" data-choice="under">Under</button>
            ...
            <section id="gameBoard" class="text-center">
                ...
                <div class="d-flex flex-row justify-content-center gap-3 mt-3">
                    <button id="playAnother" class="btn btn-light" type="button" style="display: none;">Nouvelle manche</button>
                </div>
            </section>
        </section>
    </div>
